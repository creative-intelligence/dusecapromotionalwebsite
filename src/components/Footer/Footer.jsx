  ...
  return (
    <footer className="bg-[#B79F8E] mt-20" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="flex items-center space-x-40  mt-16 border-t border-white pt-8 sm:mt-20 lg:mt-24">

          <div className="flex justify-between items-center space-x-1 " >
          <button className=" px-6 text-white bg-transparent border-2 border-white py-3 rounded-lg flex justify-center items-center mt-10">
            <svg
              className="mr-4"
              width="12"
              height="14"
          ...
          <button className=" text-white bg-transparent border-2 border-white px-6 py-3 rounded-lg flex justify-center items-center mt-10">
            <svg
              className="mr-4"
              width="15"
              height="16"
